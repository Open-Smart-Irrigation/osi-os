...
| 2.4 Extract Get Zone Environment Summary — done: `osi-zone-env` extracted (pure assembly helpers), golden-vectored, scoreboard decreased, PR #127 | osi-os | L | 2.2 pattern | spec+plan |
