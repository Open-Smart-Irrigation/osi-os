...
**Source:** vendor-supplied library, API doc, and calibration spreadsheet for the VIA Chameleon resistance sensor array.

> Captures every practical fact known about the VIA Chameleon Module relevant to the Dragino LSN50 custom-firmware integration. This doc is
