...
- [x] **Step 1 — runner extension.** Support `vector.segments` (array of byte arrays) alongside `vector.bytes`:
...
- [x] Write `docs/superpowers/plans/2026-08-19-sdi12-multi-segment-uplinks-execution-report.md` (per-task commit hashes, real gate output, deviations). Slop-check. Commit: `docs(sdi12): multi-segment execution report`.
