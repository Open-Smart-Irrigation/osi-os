...
interface IApplicationServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  listDeviceProfiles: grpc.MethodDefinition<api_application_pb.ListApplicationDeviceProfilesRequest, api_application_pb.ListApplicationDeviceProfilesResponse>;
  listDeviceTags: grpc.MethodDefinition<api_application_pb.ListApplicationDeviceTagsRequest, api_application_pb.ListApplicationDeviceTagsResponse>;
}
...
export interface IApplicationServiceServer extends grpc.UntypedServiceImplementation {
  ...
  listDeviceProfiles: grpc.handleUnaryCall<api_application_pb.ListApplicationDeviceProfilesRequest, api_application_pb.ListApplicationDeviceProfilesResponse>;
  listDeviceTags: grpc.handleUnaryCall<api_application_pb.ListApplicationDeviceTagsRequest, api_application_pb.ListApplicationDeviceTagsResponse>;
}
...
export class ApplicationServiceClient extends grpc.Client {
  ...
  listDeviceProfiles(argument: api_application_pb.ListApplicationDeviceProfilesRequest, callback: grpc.requestCallback<api_application_pb.ListApplicationDeviceProfilesResponse>): grpc.ClientUnaryCall;
  listDeviceProfiles(argument: api_application_pb.ListApplicationDeviceProfilesRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<api_application_pb.ListApplicationDeviceProfilesResponse>): grpc.ClientUnaryCall;
  listDeviceProfiles(argument: api_application_pb.ListApplicationDeviceProfilesRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<api_application_pb.ListApplicationDeviceProfilesResponse>): grpc.ClientUnaryCall;
  listDeviceTags(argument: api_application_pb.ListApplicationDeviceTagsRequest, callback: grpc.requestCallback<api_application_pb.ListApplicationDeviceTagsResponse>): grpc.ClientUnaryCall;
  listDeviceTags(argument: api_application_pb.ListApplicationDeviceTagsRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<api_application_pb.ListApplicationDeviceTagsResponse>): grpc.ClientUnaryCall;
  listDeviceTags(argument: api_application_pb.ListApplicationDeviceTagsRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<api_application_pb.ListApplicationDeviceTagsResponse>): grpc.ClientUnaryCall;
}
