...
function serialize_api_ListApplicationDeviceProfilesRequest(arg) {
  if (!(arg instanceof api_application_pb.ListApplicationDeviceProfilesRequest)) {
    throw new Error('Expected argument of type api.ListApplicationDeviceProfilesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListApplicationDeviceProfilesRequest(buffer_arg) {
  return api_application_pb.ListApplicationDeviceProfilesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_ListApplicationDeviceProfilesResponse(arg) {
  if (!(arg instanceof api_application_pb.ListApplicationDeviceProfilesResponse)) {
    throw new Error('Expected argument of type api.ListApplicationDeviceProfilesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListApplicationDeviceProfilesResponse(buffer_arg) {
  return api_application_pb.ListApplicationDeviceProfilesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_ListApplicationDeviceTagsRequest(arg) {
  if (!(arg instanceof api_application_pb.ListApplicationDeviceTagsRequest)) {
    throw new Error('Expected argument of type api.ListApplicationDeviceTagsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListApplicationDeviceTagsRequest(buffer_arg) {
  return api_application_pb.ListApplicationDeviceTagsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_ListApplicationDeviceTagsResponse(arg) {
  if (!(arg instanceof api_application_pb.ListApplicationDeviceTagsResponse)) {
    throw new Error('Expected argument of type api.ListApplicationDeviceTagsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_ListApplicationDeviceTagsResponse(buffer_arg) {
  return api_application_pb.ListApplicationDeviceTagsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
listDeviceProfiles: {
    path: '/api.ApplicationService/ListDeviceProfiles',
    requestStream: false,
    responseStream: false,
    requestType: api_application_pb.ListApplicationDeviceProfilesRequest,
    responseType: api_application_pb.ListApplicationDeviceProfilesResponse,
    requestSerialize: serialize_api_ListApplicationDeviceProfilesRequest,
    requestDeserialize: deserialize_api_ListApplicationDeviceProfilesRequest,
    responseSerialize: serialize_api_ListApplicationDeviceProfilesResponse,
    responseDeserialize: deserialize_api_ListApplicationDeviceProfilesResponse,
  },
  // List device tags used within the given application.
listDeviceTags: {
    path: '/api.ApplicationService/ListDeviceTags',
    requestStream: false,
    responseStream: false,
    requestType: api_application_pb.ListApplicationDeviceTagsRequest,
    responseType: api_application_pb.ListApplicationDeviceTagsResponse,
    requestSerialize: serialize_api_ListApplicationDeviceTagsRequest,
    requestDeserialize: deserialize_api_ListApplicationDeviceTagsRequest,
    responseSerialize: serialize_api_ListApplicationDeviceTagsResponse,
    responseDeserialize: deserialize_api_ListApplicationDeviceTagsResponse,
  },
};

exports.ApplicationServiceClient = grpc.makeGenericClientConstructor(ApplicationServiceService, 'ApplicationService');
