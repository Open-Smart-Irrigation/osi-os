...
export class FuotaDeployment extends jspb.Message {
  ...
  getMulticastGroupType(): api_multicast_group_pb.MulticastGroupTypeMap[keyof api_multicast_group_pb.MulticastGroupTypeMap];
  setMulticastGroupType(value: api_multicast_group_pb.MulticastGroupTypeMap[keyof api_multicast_group_pb.MulticastGroupTypeMap]): void;

  getMulticastClassCSchedulingType(): api_multicast_group_pb.MulticastGroupSchedulingTypeMap[keyof api_multicast_group_pb.MulticastGroupSchedulingTypeMap];
  setMulticastClassCSchedulingType(value: api_multicast_group_pb.MulticastGroupSchedulingTypeMap[keyof api_multicast_group_pb.MulticastGroupSchedulingTypeMap]): void;

  getMulticastDr(): number;
  setMulticastDr(value: number): void;

  getMulticastClassBPingSlotNbK(): number;
  setMulticastClassBPingSlotNbK(value: number): void;
  ...
  setCalculateMulticastTimeout(value: boolean): void;

  getUnicastMaxRetryCount(): number;
  setUnicastMaxRetryCount(value: number): void;
  ...
  setCalculateFragmentationFragmentSize(value: boolean): void;

  getFragmentationRedundancyPercentage(): number;
  setFragmentationRedundancyPercentage(value: number): void;
  ...
  clearOnCompleteSetDeviceTagsMap(): void;
...
export namespace FuotaDeployment {
  export type AsObject = {
    ...
    name: string,
    multicastGroupType: api_multicast_group_pb.MulticastGroupTypeMap[keyof api_multicast_group_pb.MulticastGroupTypeMap],
    multicastClassCSchedulingType: api_multicast_group_pb.MulticastGroupSchedulingTypeMap[keyof api_multicast_group_pb.MulticastGroupSchedulingTypeMap],
    multicastDr: number,
    multicastClassBPingSlotNbK: number,
...
export class CreateFuotaDeploymentRequest extends jspb.Message {
  ...
  setDeployment(value?: FuotaDeployment): void;
...
export class AddGatewaysToFuotaDeploymentRequest extends jspb.Message {
  ...
  clearGatewayIdsList(): void;
  getGatewayIdsList(): Array<string>;
  setGatewayIdsList(value: Array<string>): void;
  addGatewayIds(value: string, index?: number): string;
...
export class ListFuotaDeploymentGatewaysResponse extends jspb.Message {
  ...
  setResultList(value: Array<FuotaDeploymentGatewayListItem>): void;
...
export class ListFuotaDeploymentJobsResponse extends jspb.Message {
  ...
  setJobsList(value: Array<FuotaDeploymentJob>): void;
...
export class FuotaDeploymentJob extends jspb.Message {
  ...
  clearSchedulerRunAfter(): void;
  getSchedulerRunAfter(): google_protobuf_timestamp_pb.Timestamp | undefined;
  setSchedulerRunAfter(value?: google_protobuf_timestamp_pb.Timestamp): void;

  getWarningMsg(): string;
  setWarningMsg(value: string): void;
