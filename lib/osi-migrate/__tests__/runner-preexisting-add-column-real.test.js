...
test('affected gateway ledger applies original pending migrations through 0058', { timeout: 900000 }, async () => {
  ...
  assert.deepEqual(result.applied, [22, 23, 24, 25, 30, 54, 55, 56, 57, 58]);
