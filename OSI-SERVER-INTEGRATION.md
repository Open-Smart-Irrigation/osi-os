...
| `FIRMWARE_VERSION` | UCI `osi-server.cloud.firmware_version` | `0.4.0` |
...
var fw = env.get('FIRMWARE_VERSION') || '0.4.0';
...
set osi-server.cloud.firmware_version=0.4.0
...
start_service() {
    ...
    local fw_version=$(uci -q get osi-server.cloud.firmware_version 2>/dev/null || echo "0.4.0")
