...
assert.strictEqual(chameleonV2Fault.Chameleon_CH1_Open, null);
assert.strictEqual(chameleonV2Fault.Chameleon_CH2_Open, null);
assert.strictEqual(chameleonV2Fault.Chameleon_CH3_Open, null);
