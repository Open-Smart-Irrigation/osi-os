...
expectFileIncludes('DraginoTempCard.tsx', draginoTempCardSource, "formatSwtCardValue(channel.value, swtUnit) ?? '—'", 'keeps Chameleon SWT formatting null-safe through the shared card formatter');
