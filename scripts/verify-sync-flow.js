...
expectIncludesById('lsn50-sql-fn', 'rain_mm_per_hour, rain_delta_status', 'persists interval-aware rain metadata into device_data');
expectIncludesById('lsn50-sql-fn', 'flow_liters_per_min, flow_delta_status', 'persists interval-aware flow metadata into device_data');
