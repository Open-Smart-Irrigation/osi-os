...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 227576,
    'size total allowance: exact cumulative delta 227576',
    'size total allowance: expected exact cumulative delta 227576');
