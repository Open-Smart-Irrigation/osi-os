...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 220316,
    'size total allowance: exact cumulative delta 220316',
    'size total allowance: expected exact cumulative delta 220316');
