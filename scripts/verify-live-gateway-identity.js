...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 194074,
    'size total allowance: exact cumulative delta 194074',
    'size total allowance: expected exact cumulative delta 194074');
