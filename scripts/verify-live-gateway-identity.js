...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 171557,
    'size total allowance: exact cumulative delta 171557',
    'size total allowance: expected exact cumulative delta 171557');
