...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 221405,
    'size total allowance: exact cumulative delta 221405',
    'size total allowance: expected exact cumulative delta 221405');
