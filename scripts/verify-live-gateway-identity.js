...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 213882,
    'size total allowance: exact cumulative delta 213882',
    'size total allowance: expected exact cumulative delta 213882');
