...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 228523,
    'size total allowance: exact cumulative delta 228523',
    'size total allowance: expected exact cumulative delta 228523');
