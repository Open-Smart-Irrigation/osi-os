...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 215236,
    'size total allowance: exact cumulative delta 215236',
    'size total allowance: expected exact cumulative delta 215236');
