...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 232719,
    'size total allowance: exact cumulative delta 232719',
    'size total allowance: expected exact cumulative delta 232719');
