...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 235218,
    'size total allowance: exact cumulative delta 235218',
    'size total allowance: expected exact cumulative delta 235218');
