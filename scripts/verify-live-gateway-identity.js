...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 219199,
    'size total allowance: exact cumulative delta 219199',
    'size total allowance: expected exact cumulative delta 219199');
