...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 223779,
    'size total allowance: exact cumulative delta 223779',
    'size total allowance: expected exact cumulative delta 223779');
