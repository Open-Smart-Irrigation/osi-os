...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 228918,
    'size total allowance: exact cumulative delta 228918',
    'size total allowance: expected exact cumulative delta 228918');
