...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 229897,
    'size total allowance: exact cumulative delta 229897',
    'size total allowance: expected exact cumulative delta 229897');
