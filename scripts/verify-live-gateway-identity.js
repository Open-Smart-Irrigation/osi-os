...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 227301,
    'size total allowance: exact cumulative delta 227301',
    'size total allowance: expected exact cumulative delta 227301');
