...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 233900,
    'size total allowance: exact cumulative delta 233900',
    'size total allowance: expected exact cumulative delta 233900');
