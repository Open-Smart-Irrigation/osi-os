...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 228865,
    'size total allowance: exact cumulative delta 228865',
    'size total allowance: expected exact cumulative delta 228865');
