...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 227866,
    'size total allowance: exact cumulative delta 227866',
    'size total allowance: expected exact cumulative delta 227866');
