...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 231903,
    'size total allowance: exact cumulative delta 231903',
    'size total allowance: expected exact cumulative delta 231903');
