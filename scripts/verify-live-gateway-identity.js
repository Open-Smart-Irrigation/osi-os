...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 214531,
    'size total allowance: exact cumulative delta 214531',
    'size total allowance: expected exact cumulative delta 214531');
