...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 189830,
    'size total allowance: exact cumulative delta 189830',
    'size total allowance: expected exact cumulative delta 189830');
