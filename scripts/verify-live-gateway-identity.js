...
if (sizeAllowances) {
  ...
  expectCondition(sizeAllowances.total_allowance?.delta === 223087,
    'size total allowance: exact cumulative delta 223087',
    'size total allowance: expected exact cumulative delta 223087');
