...
test('fixture is self-consistent', () => {
  ...
  assert.equal(fixture.routes.length, 49, 'expected 49 reviewed protected routes');
  ...
  assert.equal(distinctSources.size, 45, 'expected 45 distinct reviewed auth sources');
