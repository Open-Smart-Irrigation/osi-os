...
const REQUIRED_CAPTURE_KEYS = [
  ...
  'capture.cycle.voidDependentsLoading',
  ...
  'capture.form.keyValues',
  'capture.form.layout',
  'capture.form.moreDetail',
  'capture.form.noProducts',
  'capture.form.note',
  'capture.form.optional',
  'capture.form.plotContext',
  'capture.form.product',
  'capture.form.quick',
  'capture.form.remove',
  'capture.form.required',
  'capture.form.requiredChooseOne',
  'capture.form.research',
  'capture.form.select',
  'capture.form.title',
  'capture.form.treatedAreaDefaulted',
  'capture.form.unit',
  'capture.form.value',
  'capture.next',
  ...
  'capture.validation.catalogEmpty',
  ...
  'capture.validation.invalidDefinitionDetail',
...
const REQUIRED_PHASE4_KEYS = [
  ...
  'plot.error',
  'plot.retry',
  // Slice BC (R1 Part 2): plot-static context section + apply-to-station action.
  'plot.context',
  'plot.contextHint',
  'plot.applyToStation',
  'plot.applyToStationLoading',
  'plot.applyToStationNeedsStation',
  'plot.applyToStationSuccess',
  'plot.applyToStationNone',
  'plot.applyToStationError',
  'batch.saving',
  'batch.saved',
  'batch.confirm',
  'batch.confirmCount',
