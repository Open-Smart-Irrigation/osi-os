...
// The Data view, Network, Gateway hub and Field Journal modules deliberately do
// NOT live here. They are gateway-level settings (owner decision 2026-09-17),
// read through hooks/useGatewayModules, so that every user of a gateway sees the
// same surface. Re-adding one here would create a second, silently diverging
