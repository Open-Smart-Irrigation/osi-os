...
const REVIEWED_IDENTICAL_KEYS: Record<Locale, ReadonlySet<string>> = {
  ...
  es: new Set([
    ...
    'history.irrigationTimeline.severity.info', 'history.irrigationTimeline.severity.unknown',
    'history.cardType.dendro', 'history.cardType.gateway', 'history.metadata.syncState.local',
  ...
  fr: new Set([
    ...
    'history.gatewayStatus.metric.signal', 'history.gatewayStatus.metric.cpu',
    'history.irrigationTimeline.severity.info', 'history.irrigationTimeline.severity.unknown',
    'history.cardType.dendro', 'history.cardType.irrigation', 'history.metadata.syncState.local',
    'history.metadata.aggregation.15m', 'history.soilProfile.depthLabel',
    'history.soilProfile.status.optimal', 'history.calendar.state.optimal',
  ...
  it: new Set([
    ...
    'history.irrigationTimeline.severity.info', 'history.irrigationTimeline.severity.unknown',
    'history.cardType.dendro', 'history.cardType.gateway', 'history.metadata.aggregation.15m',
  ...
  pt: new Set([
    ...
    'history.gatewayStatus.metric.cpu', 'history.cardType.dendro', 'history.cardType.gateway',
