...
- Helpers: `.touch-target` (48 px minimum tap area — this UI is used by farmers in the field), `.high-contrast-text`. Typography is the system font stack; there are no webfonts to load.
