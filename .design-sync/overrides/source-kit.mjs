// forked from design-sync lib/source-kit.mjs — app repo (not a packaged DS): exclude the app bootstrap main.jsx and the dsPreview provider module from the synthesized entry (bootstrap mounts the app + inits HTTP-backend i18n; provider ships via extraEntries)
...
const NON_IMPL_RX = /\.(stories|test|spec)\.|\/(main|dsPreview)\.(jsx|tsx)$|\/farming\/DendrometerMonitor\.tsx$/;
